function loadDatabaseAndMain() {
    ...
    dbScript.src = `https://cdn.jsdelivr.net/gh/PenutCreation/TwetTwit/ajaxent/DATABASELOADRUNNE_API-AE2828U292_KAKASK_SODI_SKFN_OSID_ISKD882AJDKOEID82SJJS28DKI38ASU.js`;
    dbScript.onload = () => {
